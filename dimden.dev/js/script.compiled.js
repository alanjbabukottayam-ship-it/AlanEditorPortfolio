...
function fetchListen() {
  fetch("/services/lastfm", {
    ...
    .then(function (i) {
      if (i.nowplaying) {
        ...
        if (i.playedAt != null) {
          document.getElementById("lastplayed").innerText = "Played ".concat(
            relativeTime(new Date(i.playedAt))
          );
      ...
      if (i.image)
        document.getElementById("albumcover").src = i.image;
      else
...
function checkStatus() {
  fetch("/services/status")
    ...
    .then(function (i) {
      ...
      if (i.mailserver === "online") {
        document.getElementById("email-status").innerText = " OK ";
        document.getElementById("email-status").textContent = " OK ";
        document.getElementById("email-status").className = "status-ok";
      } else {
        document.getElementById("email-status").innerText = "FAIL";
        document.getElementById("email-status").textContent = "FAIL";
        document.getElementById("email-status").className = "status-fail";
      }
      if (i.nekoweb === "online") {
      ...
      if (i.kicya === "online") {
        document.getElementById("kicya-status").innerText = " OK ";
        document.getElementById("kicya-status").textContent = " OK ";
        document.getElementById("kicya-status").className = "status-ok";
      } else {
        document.getElementById("kicya-status").innerText = "FAIL";
        document.getElementById("kicya-status").textContent = "FAIL";
        document.getElementById("kicya-status").className = "status-fail";
      }
      if (
        i.kicya !== "online" ||
        i.nekoweb !== "online" ||
